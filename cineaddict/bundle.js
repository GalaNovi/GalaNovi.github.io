...
const createCardMarkup = (movieData) => {
  ...
  return (
    `<article class="film-card">
      ...
      <p class="film-card__description">${shortenText(description, _const__WEBPACK_IMPORTED_MODULE_2__["DESCRIPTION_MAX_LENGTH"])}</p>
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EXTRA_MOVIES_HEADINGS, EMOTIONS, DEFAULT_SORT_TYPE, FILM_DETAILS_TITLES, FilterType, DESCRIPTION_MAX_LENGTH */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class MovieController {
  ...
  render(movieData, comments) {
    ...
    this._bigCardComponent = new _components_big_card__WEBPACK_IMPORTED_MODULE_0__["default"](this._movieData, comments);
...
class PageController {
  ...
  render() {
    ...
    const sortController = new _sort__WEBPACK_IMPORTED_MODULE_6__["SortController"](mainElement, this._moviesModel);
    this._menuController = new _menu__WEBPACK_IMPORTED_MODULE_7__["MenuController"](mainElement, this._moviesModel);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_9__["render"])(headerElement, new _components_profile__WEBPACK_IMPORTED_MODULE_4__["default"](alredyWatchedMoviesNumber));
    ...
    if (moviesForRender.length) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_9__["render"])(mainElement, new _components_no_movies_container__WEBPACK_IMPORTED_MODULE_3__["default"]());
    }
  ...
  _renderMovieCard(movieData, container = this._mainMoviesComponent.getMoviesList()) {
    ...
    const movieController = new _controllers_movie__WEBPACK_IMPORTED_MODULE_5__["MovieController"](container, this._onDataChange, this._onViewChange);
    const movieInstance = {
  ...
  _mainMoviesListInit() {
    ...
    const iterator = Object(_utils_common__WEBPACK_IMPORTED_MODULE_8__["getNextItemsIterator"])(moviesData, ADD_MOVIES_AMOUNT, this._renderedMoviesAmount);
...
class SortController {
  ...
  render() {
    const sortComponent = new _components_sort__WEBPACK_IMPORTED_MODULE_1__["default"]();
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, sortComponent);
  }
}
...
/* harmony import */ var _mock_movie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mock/movie */ "./src/mock/movie.js");
/* harmony import */ var _mock_comments__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mock/comments */ "./src/mock/comments.js");
...
const moviesData = Object(_mock_movie__WEBPACK_IMPORTED_MODULE_1__["generateMovies"])(MOVIES_AMOUNT);
const commentsData = Object(_mock_comments__WEBPACK_IMPORTED_MODULE_2__["generateComments"])();
const moviesModel = new _models_movies__WEBPACK_IMPORTED_MODULE_0__["default"]();
moviesModel.movies = moviesData;
moviesModel.comments = commentsData;
const pageController = new _controllers_page__WEBPACK_IMPORTED_MODULE_3__["PageController"](document.body, moviesModel);
...
/*!***************************!*\
  !*** ./src/mock/movie.js ***!
  \***************************/
/*! exports provided: getRandomBetween, getRandomArrayItem, generateMovies */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getRandomBetween", function() { return _utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getRandomArrayItem", function() { return _utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomArrayItem"]; });
...
const generateAgeLimit = () => Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomArrayItem"])(Array.from(ageLimits));
const generateCommentsId = () => Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["shuffleArray"])(commentsId).slice(0, Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(0, 10));
const generateTitle = () => Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomArrayItem"])(Array.from(titles));
const generatePoster = () => Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomArrayItem"])(Array.from(posters));
const generateGenres = () => Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["shuffleArray"])(Array.from(genres)).slice(0, Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(1, MAX_GENRES));
const generateDirector = () => Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomArrayItem"])(Array.from(directors));
const generateWriters = () => Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["shuffleArray"])(Array.from(writers)).slice(0, Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(1, MAX_WRITERS));
const generateActors = () => Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["shuffleArray"])(Array.from(actors)).slice(0, Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(MIN_ACTORS, MAX_ACTORS));
const generateCountry = () => Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomArrayItem"])(Array.from(countries));
const generateReleaseDate = () => new Date(`${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(1960, 2019)}, ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(1, 12)}, ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(1, 28)}`).getTime();
const generateWatchingDate = () => new Date(`2019, ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(1, 12)}, ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(1, 28)}`).getTime();
...
const generateDescription = () => {
  ...
  return sentenses.slice(0, Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(1, MAX_DESCRIPTION_SENTENSES)).join(` `).trim();
};
...
const generateMovie = (index) => {
  return {
    ...
    movieInfo: {
      ...
      rating: Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(0, 9, 1),
      duration: Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(75, 180),
      genres: generateGenres(),
      description: generateDescription(),
    },
    userInfo: {
      personalRating: Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getRandomBetween"])(0, 9),
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: capitalize, shuffleArray, getNextItemsIterator, formatTime, getRandomBetween, getRandomArrayItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
