...
class Api {
  ...
  createComment(movieId, comment) {
    ...
    .then((response) => response.json())
    .then((response) => {
      response.movie = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovie(response.movie);
      return response;
    });
  }
...
class Provider {
  ...
  getMovies() {
    ...
    return Promise.resolve(_models_movie__WEBPACK_IMPORTED_MODULE_1__["default"].parseMovies(storeMovies));
  }
  ...
  createComment(movie, comment) {
    ...
    const fakeNewCommentId = nanoid__WEBPACK_IMPORTED_MODULE_0___default()();
    ...
    return Promise.resolve({
      newMovie: _models_movie__WEBPACK_IMPORTED_MODULE_1__["default"].parseMovie(fakeNewMovie),
...
const getCommentTimeAgoText = (dateTime) => {
  ...
  if (secondsAgo < 60) {
    ...
    return moment__WEBPACK_IMPORTED_MODULE_3___default()(dateTimeStamp).format(`YYYY/MM/DD HH:mm`);
  }
};

const formatReleaseDate = (timestamp) => {
  return moment__WEBPACK_IMPORTED_MODULE_3___default()(timestamp).format(`DD MMMM YYYY`);
};
...
const createCommentMarkup = (commentData) => {
  ...
  const comment = he__WEBPACK_IMPORTED_MODULE_4___default.a.encode(notSanitizedComment);
...
const createBigCardMarkup = (movieData, commentsData) => {
  ...
  const filmDetailsMarkup = createFilmDetailsMarkup([director, writers, actors, releaseDate, Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(duration), country, genresMarkup]);
          ...
          <div class="film-details__info-wrap">
            ...
            <div class="film-details__info">
              ...
              <p class="film-details__film-description">
                ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["capitalize"])(description)}
              </p>
            </div>
          </div>
...
const createCardMarkup = (movieData) => {
  ...
  return (
    `<article class="film-card">
      ...
      <p class="film-card__description">${shortenText(Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["capitalize"])(description), _const__WEBPACK_IMPORTED_MODULE_2__["DESCRIPTION_MAX_LENGTH"])}</p>
...
class MainMovies extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  toggleShowLoadButton(areAllMoviesShown) {
    ...
    return areAllMoviesShown ?
      loadMoreButton.classList.add(_const__WEBPACK_IMPORTED_MODULE_1__["HIDDEN_CLASS"]) :
      loadMoreButton.classList.remove(_const__WEBPACK_IMPORTED_MODULE_1__["HIDDEN_CLASS"]);
  }
...
const createFilterItemMarkup = (filter, moviesModel) => {
  ...
  const counterMarkup = filter === _const__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL ? `All movies` : `${Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["capitalize"])(filter)} <span class="main-navigation__item-count">${Object(_utils_filter__WEBPACK_IMPORTED_MODULE_2__["filterMovies"])(moviesModel.movies, filter).length}</span>`;
...
const createFilterMarkup = (moviesModel) => {
  const filters = Object.values(_const__WEBPACK_IMPORTED_MODULE_3__["FilterType"]);
...
const createProfileMarkup = (moviesAmount) => {
  const userRank = moviesAmount ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getUserRank"])(moviesAmount) : null;
  return (
...
const periodFilter = {
  'all-time': (item) => item,
  'today': (item) => Number(moment__WEBPACK_IMPORTED_MODULE_5___default()(new Date(item.userInfo.watchingDate).getTime()).format(`YYYYMMDD`)) === Number(moment__WEBPACK_IMPORTED_MODULE_5___default()(new Date()).format(`YYYYMMDD`)),
  'week': (item) => new Date(item.userInfo.watchingDate).getTime() >= Date.now() - _const__WEBPACK_IMPORTED_MODULE_2__["Timestamp"].WEEK,
  'month': (item) => new Date(item.userInfo.watchingDate).getTime() >= Date.now() - _const__WEBPACK_IMPORTED_MODULE_2__["Timestamp"].MONTH,
  'year': (item) => new Date(item.userInfo.watchingDate).getTime() >= Date.now() - _const__WEBPACK_IMPORTED_MODULE_2__["Timestamp"].YEAR,
};

// Global settings for the Chart
chart_js__WEBPACK_IMPORTED_MODULE_3___default.a.helpers.merge(chart_js__WEBPACK_IMPORTED_MODULE_3___default.a.defaults, {
  scale: {
    ticks: {
      fontColor: `#ffffff`,
      padding: 80,
...
const createStatisticMarkup = (moviesData, currentFilter, isHidden) => {
  ...
  const userRank = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getUserRank"])(watchedMovies.length);
  ...
  return (
    `<section class="statistic${isHidden ? ` ${_const__WEBPACK_IMPORTED_MODULE_2__["HIDDEN_CLASS"]}` : ``}">
      ...
      <ul class="statistic__text-list">
        ...
        <li class="statistic__text-item">
          ...
          <p class="statistic__item-text">${topGenre ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["capitalize"])(topGenre) : `-`}</p>
        </li>
      </ul>
...
const getGenresStatistic = (moviesData) => {
  ...
  genres = Array.from(new Set(genres)).map((genre) => Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["capitalize"])(genre));
...
class Statistic extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _createChart(moviesData) {
    ...
    return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(this._chartContainerElement, {
      type: `horizontalBar`,
      data: {
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EXTRA_MOVIES_HEADINGS, DEFAULT_SORT_TYPE, FILM_DETAILS_TITLES, DESCRIPTION_MAX_LENGTH, HIDDEN_CLASS, userRank, FilterType, Timestamp, RequestType, MoviesAmount, MoviesType, SRC_IMAGES */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_SORT_TYPE", function() { return DEFAULT_SORT_TYPE; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MoviesAmount", function() { return MoviesAmount; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MoviesType", function() { return MoviesType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SRC_IMAGES", function() { return SRC_IMAGES; });
...
class MenuController {
  constructor(container, moviesModel, showMovies, showStatistic) {
    ...
    this._menuComponent = new _components_menu__WEBPACK_IMPORTED_MODULE_1__["default"](this._moviesModel);
  }
  ...
  render() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._menuComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["Position"].AFTERBEGIN);
  }
}
...
class MovieController {
  ...
  render(movieData, comments) {
    ...
    this._cardComponent = new _components_card__WEBPACK_IMPORTED_MODULE_1__["default"](this._movieData);
    this._bigCardComponent = new _components_big_card__WEBPACK_IMPORTED_MODULE_0__["default"](this._movieData, this._comments);
    ...
    this._bigCardComponent.setOnDeleteCommentClickCallback((commentId) => {
      const newMovieData = _models_movie__WEBPACK_IMPORTED_MODULE_2__["default"].clone(this._movieData);
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._cardComponent);
  }
  ...
  shake(requestType) {
    switch (requestType) {
      case _const__WEBPACK_IMPORTED_MODULE_4__["RequestType"].CREATING_COMMENT:
        this._bigCardComponent.alertCommentField();
        break;
      case _const__WEBPACK_IMPORTED_MODULE_4__["RequestType"].DELETING_COMMENT:
        this._bigCardComponent.alertComments();
        break;
      case _const__WEBPACK_IMPORTED_MODULE_4__["RequestType"].SETTING_RATING:
        this._bigCardComponent.alertRatingForm();
        break;
      case _const__WEBPACK_IMPORTED_MODULE_4__["RequestType"].WATCHLIST:
        this._cardComponent.alertWatchlistButton();
        this._bigCardComponent.alertWatchlistButton();
        break;
      case _const__WEBPACK_IMPORTED_MODULE_4__["RequestType"].WATCHED:
        this._cardComponent.alertWatchedButton();
        this._bigCardComponent.alertWatchedButton();
        break;
      case _const__WEBPACK_IMPORTED_MODULE_4__["RequestType"].FAVORITE:
  ...
  _openBigCard() {
    this._onViewChange();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(document.body, this._bigCardComponent);
...
/* harmony import */ var _components_movies_container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/movies-container */ "./src/components/movies-container.js");
/* harmony import */ var _components_no_movies_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/no-movies-container */ "./src/components/no-movies-container.js");
...
/* harmony import */ var _controllers_movie__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../controllers/movie */ "./src/controllers/movie.js");
/* harmony import */ var _sort__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sort */ "./src/controllers/sort.js");
/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./menu */ "./src/controllers/menu.js");
/* harmony import */ var _controllers_statistic__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../controllers/statistic */ "./src/controllers/statistic.js");
...
const renderHiddenBlockWithImages = (srcImages) => {
  ...
  Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["render"])(document.body, blockElement);
};
...
class PageController {
  constructor(container, moviesModel) {
    this._container = container;
    this._moviesModel = moviesModel;
    this._extraMoviesAmount = _const__WEBPACK_IMPORTED_MODULE_11__["MoviesAmount"].EXTRA;
    this._renderedMoviesAmount = _const__WEBPACK_IMPORTED_MODULE_11__["MoviesAmount"].START;
    this._moviesContainerComponent = new _components_movies_container__WEBPACK_IMPORTED_MODULE_2__["default"]();
  ...
  render() {
    ...
    this._sortController = new _sort__WEBPACK_IMPORTED_MODULE_6__["SortController"](mainElement, this._moviesModel);
    this._menuController = new _menu__WEBPACK_IMPORTED_MODULE_7__["MenuController"](mainElement, this._moviesModel, this._showMovies, this._showStatistic);
    this._statisticController = new _controllers_statistic__WEBPACK_IMPORTED_MODULE_8__["StatisticController"](mainElement, allMovies);
    this._profileComponent = new _components_profile__WEBPACK_IMPORTED_MODULE_4__["default"](alreadyWatchedMoviesNumber);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["render"])(headerElement, this._profileComponent);
    this._menuController.render();
    this._sortController.render();
    this._statisticController.render();

    if (moviesForRender.length) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["render"])(this._moviesContainerComponent, this._mainMoviesComponent);
      this._mainMoviesListInit(moviesForRender);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["render"])(mainElement, this._moviesContainerComponent);
      this._extraMoviesListsInit();
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["render"])(mainElement, new _components_no_movies_container__WEBPACK_IMPORTED_MODULE_3__["default"]());
    }

    renderHiddenBlockWithImages(_const__WEBPACK_IMPORTED_MODULE_11__["SRC_IMAGES"]);
  ...
  _renderMovieCard(movieData, container = this._mainMoviesComponent.getMoviesList()) {
    ...
    const movieController = new _controllers_movie__WEBPACK_IMPORTED_MODULE_5__["MovieController"](container, this._onDataChange, this._onViewChange, this._onCloseBigCard, this._getDataExchangeStatus);
    const movieInstance = {
      type: _const__WEBPACK_IMPORTED_MODULE_11__["MoviesType"].MAIN,
      controller: movieController,
    };

    if (container !== this._mainMoviesComponent.getMoviesList()) {
      movieInstance.type = _const__WEBPACK_IMPORTED_MODULE_11__["MoviesType"].EXTRA;
    }
  ...
  _renderExtraMovies(movies, heading) {
    ...
    if (doesHasMovies) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_10__["render"])(this._moviesContainerComponent, extraMoviesComponent);
    }
  }

  _mainMoviesListInit() {
    this._clearMovies(_const__WEBPACK_IMPORTED_MODULE_11__["MoviesType"].MAIN);
    const moviesData = this._moviesModel.getMoviesForRender();
    const iterator = Object(_utils_common__WEBPACK_IMPORTED_MODULE_9__["getNextItemsIterator"])(moviesData, _const__WEBPACK_IMPORTED_MODULE_11__["MoviesAmount"].ADD, this._renderedMoviesAmount);
    this._renderMainMovies(iterator);
    this._mainMoviesComponent.setCallback(() => {
      this._renderMainMovies(iterator);
      this._renderedMoviesAmount += _const__WEBPACK_IMPORTED_MODULE_11__["MoviesAmount"].ADD;
    });
  }
  ...
  _extraMoviesListsInit() {
    ...
    this._renderExtraMovies(topRatedMovies, _const__WEBPACK_IMPORTED_MODULE_11__["EXTRA_MOVIES_HEADINGS"][0]);
    this._renderExtraMovies(mostCommentedMovies, _const__WEBPACK_IMPORTED_MODULE_11__["EXTRA_MOVIES_HEADINGS"][1]);
  }
  ...
  _clearExtraMovies() {
    this._clearMovies(_const__WEBPACK_IMPORTED_MODULE_11__["MoviesType"].EXTRA);
  ...
  _isExtraMoviesRatingChange() {
    const currentExtraMoviesIdsString = this._shownMoviesInstances
      .filter((item) => item.type === _const__WEBPACK_IMPORTED_MODULE_11__["MoviesType"].EXTRA)
  ...
  _onDataChange(oldMovie, newMovie, movieController) {
    ...
    if (oldMovie.comments.length > newMovie.comments.length) {
      requestType = _const__WEBPACK_IMPORTED_MODULE_11__["RequestType"].DELETING_COMMENT;
      ...
      requestType = _const__WEBPACK_IMPORTED_MODULE_11__["RequestType"].CREATING_COMMENT;
      ...
      if (oldMovie.userInfo.isOnTheWatchlist !== newMovie.userInfo.isOnTheWatchlist) {
        requestType = _const__WEBPACK_IMPORTED_MODULE_11__["RequestType"].WATCHLIST;
      } else if (oldMovie.userInfo.isAlreadyWatched !== newMovie.userInfo.isAlreadyWatched) {
        requestType = _const__WEBPACK_IMPORTED_MODULE_11__["RequestType"].WATCHED;
      } else if (oldMovie.userInfo.isFavorite !== newMovie.userInfo.isFavorite) {
        requestType = _const__WEBPACK_IMPORTED_MODULE_11__["RequestType"].FAVORITE;
      } else {
        requestType = _const__WEBPACK_IMPORTED_MODULE_11__["RequestType"].SETTING_RATING;
      }
  ...
  _updatePage(oldMovie, newMovie) {
    ...
    this._profileComponent.updateRating(Object(_utils_common__WEBPACK_IMPORTED_MODULE_9__["getUserRank"])(alreadyWatchedMovies.length));
...
class SortController {
  ...
  render() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._sortComponent);
  }
...
/*!**************************************!*\
  !*** ./src/controllers/statistic.js ***!
  \**************************************/
/*! exports provided: StatisticController */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatisticController", function() { return StatisticController; });
/* harmony import */ var _components_statistic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/statistic */ "./src/components/statistic.js");
...
class StatisticController {
  constructor(container, moviesData) {
    this._container = container;
    this._moviesData = moviesData;
    this._statisticComponent = new _components_statistic__WEBPACK_IMPORTED_MODULE_0__["default"](this._moviesData);
  }

  render() {
    this._statisticComponent.renderChart();
    this._statisticComponent.setOnFilterClickHandler();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._statisticComponent);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _models_movies__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/movies */ "./src/models/movies.js");
/* harmony import */ var _api_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api/index */ "./src/api/index.js");
/* harmony import */ var _api_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api/store */ "./src/api/store.js");
/* harmony import */ var _api_provider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api/provider */ "./src/api/provider.js");
/* harmony import */ var _controllers_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/page */ "./src/controllers/page.js");
...
const AUTHORIZATION_CODE = `Basic kjasrhgfkuGierbYUUfIYtfjytf`;

const api = new _api_index__WEBPACK_IMPORTED_MODULE_1__["default"](END_POINT, AUTHORIZATION_CODE);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_2__["default"](storeName, window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_3__["default"](api, store);
const moviesModel = new _models_movies__WEBPACK_IMPORTED_MODULE_0__["default"](apiWithProvider);
const pageController = new _controllers_page__WEBPACK_IMPORTED_MODULE_4__["PageController"](document.body, moviesModel);
...
moviesModel.getMovies()
  ...
  .then(() => {
    ...
    Object(_utils_common__WEBPACK_IMPORTED_MODULE_5__["removeMainPreloader"])();
  });
...
class Movies {
  constructor(apiWithProvider) {
    ...
    this._movies = null;
    this._comments = [];
    this._filterType = _const__WEBPACK_IMPORTED_MODULE_2__["FilterType"].ALL;
    this._sortType = _const__WEBPACK_IMPORTED_MODULE_2__["DEFAULT_SORT_TYPE"];
  ...
  getMoviesForRender() {
    ...
    moviesCopy = Object(_utils_filter__WEBPACK_IMPORTED_MODULE_1__["filterMovies"])(moviesCopy, this._filterType);
    moviesCopy = Object(_utils_sort__WEBPACK_IMPORTED_MODULE_0__["sortMovies"])(moviesCopy, this._sortType);
    return moviesCopy;
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: capitalize, getNextItemsIterator, formatTime, getUserRank, removeMainPreloader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeMainPreloader", function() { return removeMainPreloader; });
...
const formatTime = (duration) => {
  const time = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration, `minutes`);
  return `${time.hours()}h ${time.minutes()}m`;
};

const getUserRank = (moviesAmount) => {
  return moviesAmount ?
    _const__WEBPACK_IMPORTED_MODULE_1__["userRank"][Object.keys(_const__WEBPACK_IMPORTED_MODULE_1__["userRank"]).reverse().find((key) => moviesAmount > key || moviesAmount === 0)] :
    _const__WEBPACK_IMPORTED_MODULE_1__["userRank"][0];
};
...
const filterMovies = (moviesData, filterType) => {
  if (filterType === _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL) {
    return moviesData;
  }
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: createElement, render, replace, Position */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const render = (instanceContainer, instanceElement, place = Position.BEFOREEND) => {
  ...
  if (instanceContainer instanceof _components_abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"]) {
    container = instanceContainer.getElement();
  }

  if (instanceElement instanceof _components_abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"]) {
...
const sortMovies = (moviesData, sortType) => {
  if (sortType === _const__WEBPACK_IMPORTED_MODULE_0__["DEFAULT_SORT_TYPE"]) {
    return moviesData;
  }
