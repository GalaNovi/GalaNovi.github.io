...
var Modal = function Modal(options) {
  ...
  var openModal = function openModal() {
    ...
    CLOSE_BUTTONS.forEach(function (button) {
      return button.addEventListener('click', onCloseButtonClick);
    });
    CLOSE_BUTTONS.forEach(function (button) {
      return button.addEventListener('keydown', onCloseButtonKeydown);
  ...
  var closeModal = function closeModal() {
    ...
    hideOverlay();
    CLOSE_BUTTONS.forEach(function (button) {
      return button.removeEventListener('click', onCloseButtonClick);
    });
    CLOSE_BUTTONS.forEach(function (button) {
      return button.removeEventListener('keydown', onCloseButtonKeydown);
